        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!!Form::open(['action' => 'App\Http\Controllers\RoleController@updaterole', 'method' => 'POST' , 'enctype' => 'multipart/form-data'])!!}
              {{ csrf_field() }}
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  {{Form::label('', 'Role', ['for' => 'exampleInputEmail1' ])}}
                  {{Form::text('rolename', '',  ['placeholder' => 'Role','class' => 'form-control', 'id'=> 'exampleInputEmail1' ])}}
                </div>
