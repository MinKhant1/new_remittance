...
@endif
  ...
  {!!Form::open(['action' => 'App\Http\Controllers\InwardTransactionController@updateinwardtransaction', 'method' => 'POST' , 'enctype' => 'multipart/form-data'])!!}
  {{ csrf_field() }}
    <!--  General -->
    ...
    <div class="form-row" style="margin: 2% 2% 2% 18%">
      ...
      <div class="col-3" style="margin-left: 20%">
        ...
        <input type="text" class="form-control mb-2 mr-sm-2"  placeholder="Transaction No" id="sr_id" name="sr_id" value="{{$inward_transaction->sr_id}}" readonly>
      </div>
      ...
      <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="receiver_name" name="receiver_name" value="{{$inward_transaction->receiver_name}}">
    </div>
    ...
    <div class="" hidden>
      ...
      <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="hidden_add_ph"  value="{{$inward_transaction->receiver_address_ph}}" >
    </div>

    <div class="col-2">
      <label for="receiver_address" class="mr-sm-2">Receiver Address:</label>
      <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="receiver_address" name="receiver_address" value="">
    </div>

    <div class="col-2">
      <label for="receiver_phno" class="mr-sm-2">Receiver Phone:</label>
      <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="receiver_phno" name="receiver_phno" value="">
    </div>
    ...
    <div class="col-6">
      ...
      <textarea class="form-control mb-2 mr-sm-2" id="remark_withdraw_point" rows="5" cols="40" name="remark_withdraw_point" id="remark_withdraw_point">{{$inward_transaction->remark_for_withdraw_point}}</textarea>
    </div>
    ...
    <div class="col-3">
      ...
      <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="sender_name"  name="sender_name" value="{{$inward_transaction->sender_name}}">
    </div>

    <div class="col-3">
      <label for="nrc_id" class="mr-sm-2">NRC/Passport ID:</label>
      <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="nrc_id"  name="sender_nrc_passport" value="{{$inward_transaction->sender_nrc_passport}}">
    </div>

    <div class="col-2">
      <label for="sender_country" class="mr-sm-2">Country</label>
      <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="sender_country" name="sender_country" value="{{$inward_transaction->sender_country_code}}">
    </div>
    ...
    {{-- <div class="col-2">
      <label for="sender_country" class="mr-sm-2">Currency</label>
      <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="prefer_currency" name="prefer_currency" value="">
    </div>
     --}}
    ...
    <div class="col-2">
      <label for="receiver_name" class="mr-sm-2">MMK</label>
...
<div class="col-2"></div>
  ...
  <script>
     ...
     jQuery(document).ready(function()
     {
      ...
      let address = document.getElementById('receiver_address');
      let ph = document.getElementById('receiver_phno');
