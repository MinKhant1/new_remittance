...
@endif
  ...
  {!!Form::open(['action' => 'App\Http\Controllers\OutwardTransactionController@updateoutwardtransaction', 'method' => 'POST' , 'enctype' => 'multipart/form-data'])!!}
  {{ csrf_field() }}
    <!--  General -->
    {{Form::hidden('id', $outward_transaction->id)}}
   <div class="form-row" style="margin: 2% 2% 2% 18%">
    <div class="col-12">
      <p class="text-bold" style="color:black; font-size:25px">Edit Outward Transaction </p>
    </div>
    <div class="col-2">
 ...
 <input type="hidden" name="exchange_rate_input_usd" id="exchange_rate_input_usd" value="2100">
    ...
    <div class="col-3" style="margin-left: 20%">
      ...
      <input type="text" class="form-control mb-2 mr-sm-2" readonly placeholder="Transaction No" id="sr_id" name="sr_id" value="{{$outward_transaction->sr_id}}">
    </div>
    ...
    <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="sender_name" name="sender_name" value="{{$outward_transaction->sender_name}}">
  </div>
  ...
  <div class="" hidden>
    <label for="receiver_name" class="mr-sm-2">Hidden Address/phno:</label>
    <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="hidden_add_ph"  value="{{$outward_transaction->sender_address_ph}}" >
  </div>

  <div class="col-3">
    <label for="receiver_address" class="mr-sm-2">Sender Address:</label>
    <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="sender_address" name="sender_address" value="{{old('sender_address')}}">
  </div>

  <div class="col-3">
    <label for="receiver_phno" class="mr-sm-2">Sender Phone:</label>
    <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="sender_phno" name="sender_phno" value="{{old('sender_phno')}}">
  </div>
  ...
  <div class="col-3">
    ...
    <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="deposit_point"  name="deposit_point" value="{{$outward_transaction->deposit_point}}">
  </div>

  <div class="col-6">
    <label for="remark_withdraw_point" class="mr-sm-2">Remark for Deposit Point:</label>
    <textarea name="" class="form-control mb-2 mr-sm-2" id="" rows="5" cols="40" name="remark_deposit_point">{{$outward_transaction->remark_for_deposit_point}}</textarea>
  </div>
  ...
  <div class="col-3">
    ...
    <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="receiver_name"  name="receiver_name" value="{{$outward_transaction->receiver_name}}">
  </div>

  <div class="col-3">
    <label for="nrc_id" class="mr-sm-2">NRC/Passport ID:</label>
    <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="receiver_nrc_passport"  name="receiver_nrc_passport" value="{{old('receiver_nrc_passport')}}">
  </div>

  <div class="col-2">
    <label for="sender_country" class="mr-sm-2">Country</label>
    <input type="text" class="form-control mb-2 mr-sm-2" placeholder="" id="receiver_country" name="receiver_country" value="{{$outward_transaction->receiver_country_code}}">
  </div>
...
<script>
  ...
  jQuery(document).ready(function()
  {
   let addressPh_field=document.getElementById('hidden_add_ph');
   let add_ph=addressPh_field.value;
   let add_ph_string = add_ph.toString();
   let splitStr = add_ph_string.split('/');
   let address = document.getElementById('sender_address');
   let ph = document.getElementById('sender_phno');
   address.value = splitStr[0];
   ph.value = splitStr[1];
  });
