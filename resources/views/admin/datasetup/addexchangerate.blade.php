        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!!Form::open(['action' => 'App\Http\Controllers\ExchangerateController@saveexchangerate', 'method' => 'POST' , 'enctype' => 'multipart/form-data'])!!}
              {{ csrf_field() }}
              <div class="card-body">
                <div class="form-group">
                  ...
                  {{Form::select('currency_code', $currencies, null, ['placeholder' => 'Select Currency Code','class' => 'form-control', 'id'=> 'exampleInputEmail1' ])}}
                </div>
                ...
                <div class="form-group">
                    ...
                    {{Form::text('exchange_rate', '',  ['placeholder' => 'Currency Rate','class' => 'form-control', 'id'=> 'exampleInputEmail1' ])}}
                  </div>
