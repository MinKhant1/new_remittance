        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!!Form::open(['action' => 'App\Http\Controllers\CurrencyController@updatecurrency', 'method' => 'POST' , 'enctype' => 'multipart/form-data'])!!}
              {{ csrf_field() }}
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="currency_code"  name="currency_code">
                    ...
                    <option value="{{$currency->currency_name}}">{{$currency->currency_code}}</option>
                    @endforeach
                  </select>
                </div>
