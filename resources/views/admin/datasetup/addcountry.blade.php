        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!!Form::open(['action' => 'App\Http\Controllers\CountryController@savecountry', 'method' => 'POST' , 'enctype' => 'multipart/form-data'])!!}
              {{ csrf_field() }}
              <div class="card-body">
...
<script>
  ...
  // {
    ...
    //   let countryNameIndex=document.getElementById('country_name').selectedIndex;
    //   let countryCode=document.getElementById('country_code');
    //   countryCode.selectedIndex=countryNameIndex;
