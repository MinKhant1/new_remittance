          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Edit Purpose of Transactions</h3>
              </div>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!!Form::open(['action' => 'App\Http\Controllers\PurposeOfTransController@updatepurposeoftrans', 'method' => 'POST' , 'enctype' => 'multipart/form-data'])!!}
              {{ csrf_field() }}
              <div class="card-body">

                <div class="form-group">
                  {{Form::hidden('id', $purposes->id)}}
                  {{-- <label for="exampleInputEmail1">Product name</label>
                  <input type="text" name="product_name" class="form-control" id="exampleInputEmail1" placeholder="Enter product name"> --}}
                  {{Form::label('', 'Purpose of Transactions', ['for' => 'exampleInputEmail1' ])}}
                  {{Form::text('purpose_name', '',  ['placeholder' => $purposes->purpose_name,'class' => 'form-control', 'id'=> 'exampleInputEmail1' ])}}
                </div>
