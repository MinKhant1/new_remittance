          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Add Withdraw Point</h3>
              </div>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!!Form::open(['action' => 'App\Http\Controllers\WithdrawPointController@savewithdrawpoint', 'method' => 'POST' , 'enctype' => 'multipart/form-data'])!!}
              {{ csrf_field() }}
              <div class="card-body">
                <div class="form-group">
                  ...
                  {{Form::text('withdraw_point_name', '',  ['placeholder' => 'Withdraw Point','class' => 'form-control', 'id'=> 'exampleInputEmail1' ])}}
                </div>
