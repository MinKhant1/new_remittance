          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Edit Withdraw Point</h3>
              </div>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!!Form::open(['action' => 'App\Http\Controllers\WithdrawPointController@updatewithdrawpoint', 'method' => 'POST' , 'enctype' => 'multipart/form-data'])!!}
              {{ csrf_field() }}
              <div class="card-body">

                <div class="form-group">
                  {{Form::hidden('id', $withdraw_point->id)}}
                  {{-- <label for="exampleInputEmail1">Product name</label>
                  <input type="text" name="product_name" class="form-control" id="exampleInputEmail1" placeholder="Enter product name"> --}}
                  {{Form::label('', 'Withdraw Point', ['for' => 'exampleInputEmail1' ])}}
                  {{Form::text('withdraw_point_name', '',  ['placeholder' => $withdraw_point->withdraw_point_name,'class' => 'form-control', 'id'=> 'exampleInputEmail1' ])}}
                </div>
