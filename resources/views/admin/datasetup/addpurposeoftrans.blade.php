          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Add New Purpose</h3>
              </div>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!!Form::open(['action' => 'App\Http\Controllers\PurposeOfTransController@savepurposeoftrans', 'method' => 'POST' , 'enctype' => 'multipart/form-data'])!!}
              {{ csrf_field() }}
              <div class="card-body">
                <div class="form-group">
                  {{-- <label for="exampleInputEmail1">Product name</label>
                  <input type="text" name="product_name" class="form-control" id="exampleInputEmail1" placeholder="Enter product name"> --}}
                  {{Form::label('', 'Purpose Of Transaction', ['for' => 'exampleInputEmail1' ])}}
                  {{Form::text('purpose_name', '',  ['placeholder' => '','class' => 'form-control', 'id'=> 'exampleInputEmail1' ])}}
                </div>
