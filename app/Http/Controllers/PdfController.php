        ...
        try{
          ...
          if (!empty($text30_startdate)) {
            ...
            if (!empty($text30_enddate)) {
              ...
              if (Carbon::now()->isAfter($text30_startdate) && Carbon::now()->isBefore($text30_enddate)) {
                $pdf->loadHTML($this->text30_convert_orders_data_to_html());
              }
              else
              {
            ...
            else
            {
              ...
              if (Carbon::now()->isAfter($text30_startdate)) {
                $pdf->loadHTML($this->text30_convert_orders_data_to_html());
              }
              else
              {
...
<table style="border: 2px solid black;border-collapse:collapse;width:100%">
    ...
    public function text30_convert_orders_data_to_html(){
